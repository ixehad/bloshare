...
Found at **Bloshare** in your WordPress dashboard sidebar:
...
- If a post already contains `[bls_ai_buttons]`, auto-injection of the AI row is skipped for that post — no duplicates
...
1. Download the latest `.zip` from [Releases](https://github.com/ixehad/bloshare/releases)
2. In WordPress admin → **Plugins → Add New → Upload Plugin**
3. Upload the zip → **Install Now → Activate**
4. Go to **Bloshare** in the left sidebar
...
│   └── icon-256x256.png
├── includes/
│   ├── class-bls-settings.php    # Two-tab admin settings page
│   ├── class-bls-render.php      # Button HTML output (text/icon/icon+text)
│   └── class-bls-loader.php      # Shortcodes + per-row content injection
